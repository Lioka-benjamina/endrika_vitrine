      ...
      <Container className="relative z-10">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-[2.1rem] font-bold leading-[1.15] tracking-[-0.02em] text-endrika-dark dark:text-white sm:text-[2.4rem]">
            {t("Des projets")}{" "}
            <span className="text-endrika-red">{t("concrets,")}</span>{" "}
            {t("pensés pour des besoins réels.")}
          </h2>

          <p className="mt-4 text-[1rem] leading-7 text-endrika-muted/75 dark:text-white/50">
            {t("Quelques exemples de solutions que nous pouvons concevoir pour accompagner les entreprises dans leur transformation digitale.")}
          </p>
        </div>
